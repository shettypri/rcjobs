...
//
//     }
//     console.log("data is availabhadha", fetchAds.data)
//     return (
//         <>
//             {
//                 buyDetails ? (
...
//                                         fetchAds.Success && (
//                                             <>
//                                                 {/*<div className={showAdsOnSwipe?"block max-sm:full max-sm:h-full":"hidden"}>*/}
//                                                 {/*    <Google_Ads/>*/}
//                                                 {/*</div>*/}
//                                                 {
//                                                     // showAdsOnSwipe ? (
//                                                     //     <div className={"max-sm:w-full w-full flex flex-col":"hidden"}>
//                                                     //         <Google_Ads/>
//                                                     //         <Google_Ads/>
//                                                     //     </div>
//                                                     // ) : (
...
//                                                                     return (
//                                                                         <>
//                                                                             {/*<div className={showAdsOnSwipe?"max-sm:w-full w-full flex flex-col":"hidden"}>*/}
//                                                                             {/*    <Google_Ads/>*/}
//                                                                             {/*    <Google_Ads/>*/}
//                                                                             {/*</div>*/}
//                                                                             <div className={"w-full  mx-auto max-2xl:w-3/4 max-xl:w-full max-sm:bg-red-100 max-sm:w-full max-sm:m-0 px-0"}
//                                                                                  key={index}>
//                                                                                 <div className=" block ">
//
