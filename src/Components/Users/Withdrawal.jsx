        ...
        <>
            <div className=" w-1/2 mx-auto mt-2 shadow-xl shadow-black rounded-xl ">
                <div className="flex flex-col bg-gray-800 font-mono text-2xl">
                    <div className="p-4 flex flex-row">
                        <div className="flex flex-col">
                            <label
                                className="text-2xl text-white font-bold mx-auto drop-shadow-xl py-2 px-2 mt-4"> {walletData.data.name}</label>
                            <label
                                className="text-2xl text-white font-bold mx-auto drop-shadow-xl py-2 px-2 mt-4"> Total
                                Amount</label>
                        </div>
                ...
                <div className="flex flex-row justify-around ">
                    <label className="px-2 py-2 mt-1 mx-auto uppercase">No. of new Referred </label>
                    <label className="px-2 py-2 mt-1 mx-auto uppercase">{walletData.data.referred}</label>
                </div>

                <div className="flex flex-row justify-around ">
                    <label className="px-2 py-2 mt-1 mx-auto uppercase">all Reference Amount</label>
                ...
                <div className="bg-gray-800 py-4 flex rounded">
                    <label className="mx-auto text-white text-2xl ">
                        Wallet Amount
                    </label>
                    ...
                    showWithDraWal ?(
                        <div className="py-2">
                            <div className="flex flex-row justify-around  bg-blue-200">
                                <label className="px-2 py-2 mt-1 mx-auto uppercase"> Ads Wallet</label>
                                <label className="px-2 py-2 mt-1 mx-auto uppercase">
                                    {
                            ...
                            <div className="flex flex-row justify-around  bg-blue-200">
                                <label className="px-2 py-2 mt-1 mx-auto uppercase"> Withdrawal Reference Amount Wallet</label>
                                <label className="px-2 py-2 mt-1 mx-auto uppercase">
                                    {
                            ...
                            <div className="flex flex-row justify-around  bg-blue-200">
                                <label className="ppx-2 py-2 mt-1 mx-auto uppercase"> Total Amount Wallet</label>
                                                        ...
                                                        <div>
                                                            {
                                                                walletData.data.wallet < 250 ?
                                                                    (<div className="flex">
                                                                        <lable className="mx-auto font-bold text-red-600">
                                                                            total wallet should have more than 250 for withdrawal
                                                                        </lable>
                                                                    </div>) : (
