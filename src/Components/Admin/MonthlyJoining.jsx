        ...
        <>
            <div className="flex flex-col bg-gray-800 w-3/4 mx-auto rounded">
                <div className="flex flex-row justify-around py-4 ">
                    <label className="text-white text-3xl p-8">Number of users &nbsp;{customerUser.data.length}</label>
                    <label className="text-white text-3xl border-2 rounded-full p-8"> {(customerUser.data.length)*1000}</label>
                </div>
