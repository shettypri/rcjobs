...
import AffliatePurchase from "./utils/AffliatePurchase.jsx";
import AffilateAnonymous from "./utils/AffilateAnonymous.jsx";
                ...
                <div className="w-full ">
                    <table className="w-full">
                        <tr className="mx-2">
                            ...
                            <th className="border-2 border-black px-3 py-1 max-sm:px-2 max-sm:py-0 max-sm:text-xs uppercase">Customer Info</th>
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td className="border-2 border-black px-7 py-2 uppercase font-bold">
                                            ...
                                            <div>
                                                ...
                                                <section className="py-1 flex flex-row">
                                                    <section>{product.userName}</section>
                                                    {
                                                        product.isAffiliated &&
                                                        product.isAnonymous &&
                                                        <AffilateAnonymous />
                                                ...
                                                <section className="py-1 ">{product.cust_Phone}</section>
                                                <div className="bg-gray-300 px-4 py-3 flex flex-col">
                                                    <section className="py-1 ">{product.address}</section>
                                                    <section className="py-1 ">{product.Pincode}</section>
                                                </div>
